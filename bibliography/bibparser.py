...
def parse_bib_file():
    ...
    bib_items = parse_bibtex_file("./bibliography/content/publications.bib", "./bibliography/content/fullstrings.bib")

    print("retreiving list of diag members")
    list_researchers = get_list_researchers("./bibliography/content/members")
    ...
    save_dict2json("./bibliography/content/bibitems.json", bib_items)
    print("saving authorbibkeys.json")
    save_dict2json("./bibliography/content/authorkeys.json", bib_items_per_author_per_date)
    print("saving groupbibkeys.json")
    save_dict2json("./bibliography/content/groupkeys.json", bib_items_per_group_per_date)
